...
public class ProductController {
    ...
    public Result uploadImg(MultipartFile file){
        ...
        try {
            ...
            //拿到图片保存到的磁盘路径
            String upLoadFilePath = uploadDirPath + "\\" + file.getOriginalFilename();
            //保存图片
    ...
    public Result deleteProductList(@RequestBody List<Integer> productList) {
        Result result = productService.deleteProductByIds(productList);
        return result;
    }
